...
<head>
    <meta charset="UTF-8">
    <title><?php echo ($meta_title); ?> - 后台管理系统</title>
...
<body>
    ...
    <form action="" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">用户名<span class="check-tips">（用户名不能少于6个字符或多于20个字符）</span></label>
            <div class="controls">
        ...
        <div class="cont-ft">
            <div class="copyright">
                <div class="fl">感谢使用后台管理系统</div>
                <div class="fr"><?= date('Y-m-d H:i:s') ?></div>
            </div>
        </div>
    </div>
    <!-- /内容区 -->
